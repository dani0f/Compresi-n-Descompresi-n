...
file = Path("lena.jpg") # or Path('./doc.txt')
size0 = file.stat().st_size
file = Path("dct.jpg") # or Path('./doc.txt')
size1 = file.stat().st_size

print("tiempo: ",elapsed_time)
print("tamaño antes de compresión",size0)
print("tamaño dsp de compresión",size1)
